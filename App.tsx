...
const REVIEWS = [
  // A. 逃離親戚與噪音 (不想拜年篇) (1-5)
  "初三不想去拜年，躲來台南安南區喝咖啡。這家在本原街的隱藏版甜點環境很安靜，低糖千層蛋糕適合怕吵的人。",
  "為了躲避親戚，跑到台南果菜市場附近的巷弄。發現這間質感咖啡店，西西里咖啡跟烤布丁剛好可以讓耳朵休息一下。",
  "初三的安南區意外清幽。這家位於本原街的甜點店，雖然在果菜市場旁但隔音不錯，推薦給需要安靜空間的人。",
  "過年期間不想人擠人，找到這家國道8號附近的隱藏版甜點。千層蛋糕口味很多，適合初三出門透氣。",
  "被台南安南區的朋友帶來這裡避難。隱身在本原街的民宅區，手作甜點水準不錯，是過年期間的綠洲。",

  // B. 解膩與換口味 (吃膩年菜篇) (6-10)
  "吃了三天年菜覺得膩，特地來安南區本原街找甜點。這裡的西西里咖啡酸度剛好解膩，千層蛋糕也不會太甜。",
  "初三只想喝一杯冰美式。這家在台南果菜市場旁的店，咖啡跟烤布丁的搭配很清爽，適合過年解膩。",
  "過年大魚大肉後，來安南區吃點低糖甜點。這家隱藏版店家的千層蛋糕鮮奶油很輕盈，吃完不會有負擔。",
  "位於本原街的甜點店，主打減糖製作。對於初三想吃甜點又怕胖的人來說，這裡的水果千層是個好選擇。",
  "在台南果菜市場附近發現的解膩好店。檸檬美式非常有水準，搭配原味千層，剛好消除過年聚餐的油膩感。",

  // C. 慵懶與睡到飽 (初三爛泥篇) (11-15)
  "初三睡到下午才出門，來安南區本原街吃下午茶。店內氣氛放鬆，烤布丁跟拿鐵是喚醒靈魂的組合。",
  "過年就是要睡飽吃甜點。這家台南安南區的隱藏版，距離國道8號不遠。千層蛋糕是現做的，值得專程開車來。",
  "慵懶的初三午後，在果菜市場旁找到這家店。沒有過度喧嘩的吵雜，只有好吃的手作甜點與咖啡。",
  "不用早起拜年的日子，來本原街喝咖啡。這間安南區甜點店有提供插座，適合帶著手機來這裡發呆一下午。",
  "趁著初三大家都出遠門，來台南安南區挖掘在地美食。這家隱藏版千層口感紮實，是睡飽後的第一餐。",

  // D. 伴手禮與收心 (假期中場篇) (16-20)
  "初三來台南果菜市場附近買水果，順便帶了這家的千層蛋糕。包裝很有質感，適合當作去朋友家拜訪的安南區伴手禮。",
  "回程上國道8號前，先繞進本原街外帶甜點。烤布丁可以外帶，對於過年期間需要送禮的人來說很方便。",
  "在安南區找到可以預訂生日蛋糕的店。雖然是初三，但店家服務親切，客製化蛋糕的討論也很專業。",
  "過年期間還有營業的安南區咖啡店。位於本原街巷弄，適合初三約朋友來吃下午茶收心，推提拉米蘇。",
  "這家隱藏版甜點就在台南果菜市場隔壁。初三來這裡外帶綜合千層回家追劇，是過年最舒服的行程。"
];
