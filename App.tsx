...
const REVIEWS = [
  // 初二/過年限定：回娘家與加菜 (1-5)
  "初二回娘家在台南安南區找甜點，發現這家鄰近果菜市場的隱藏版小店。買了低糖千層蛋糕與布丁當作飯後點心，家人接受度很高。",
  "過年期間到安南區走春，順路造訪本原街的甜點店。雖然沒有販售禮盒，但外帶了幾片千層蛋糕與烤布丁回家，適合初二團聚分享。",
  "位於台南果菜市場旁的甜點工作室，Google Maps 定位準確。初二下午帶了招牌的千層蛋糕與巴斯克回家，是安南區在地的質感甜點。",
  "為了初二聚餐找的飯後甜點，地點在安南區本原街。主打減糖製作的千層蛋糕，長輩也能接受。店內也有販售咖啡，適合等待時外帶。",
  "台南安南區的隱藏版甜點，適合過年期間買回家加菜。推薦招牌的烤布丁與提拉米蘇，位置就在熱鬧的果菜市場附近。",

  // 地理位置：果菜市場與本原街 (6-10)
  "隱身在安南區本原街巷弄中的甜點店，距離國道8號不遠。店內環境安靜，主要販售千層蛋糕與手作布丁，是果菜市場周邊的休息好去處。",
  "路過台南果菜市場發現的咖啡甜點店。雖然外觀低調，但千層蛋糕口味選擇多。位於本原街上，停車相對方便，適合快速外帶。",
  "安南區在地人推薦的本原街甜點。位置隱密，建議跟著導航走。店內提供低糖甜點與咖啡內用，是遠離過年人潮的放鬆角落。",
  "位於台南安南區的甜點秘境，鄰近果菜市場。專賣手作千層與烤布丁，沒有過度包裝，強調食材原味，適合喜歡單純甜點的人。",
  "在安南區本原街的巷子裡，有一間主打北海道十勝奶霜的甜點店。距離果菜市場很近，過年期間也有營業，適合買甜點回家享用。",

  // 產品特色：千層、布丁、提拉米蘇 (11-15)
  "台南安南區少見的低糖千層蛋糕專賣。餅皮薄透，鮮奶油清爽不膩。店址位於本原街，也有提供提拉米蘇與巴斯克蛋糕。",
  "這家店的烤焦糖布丁非常綿密，是安南區甜點的隱藏招牌。地點在果菜市場旁，除了千層蛋糕外，也有手沖咖啡可以搭配。",
  "本原街上的質感小店，主打透明盒裝的提拉米蘇與手作千層。甜度控制得宜，適合不愛吃甜的人。過年期間建議提前確認品項。",
  "專程來安南區買的千層蛋糕，口味多樣且新鮮。店內也有販售美式與西西里咖啡，位於果菜市場後方，位置相當隱密。",
  "喜歡吃巴斯克與布丁的人推薦這家安南區甜點。位於本原街，雖然沒有華麗的禮盒包裝，但甜點口感紮實，物有所值。",

  // 綜合體驗：適合誰來 (16-20)
  "適合過年想找地方喝咖啡的人，位於安南區本原街。店內氣氛悠閒，千層蛋糕與布丁都是人氣商品，鄰近台南果菜市場。",
  "台南安南區的隱藏版下午茶，不收服務費。主要提供外帶甜點與簡單的內用座位。初二過後若想吃低糖蛋糕，這裡是個好選擇。",
  "在本原街發現的優質甜點店。老闆親切，對於原料很講究。推薦給想在果菜市場附近找好吃千層蛋糕與咖啡的人。",
  "不用跑到市區，安南區本原街就有水準不錯的甜點。烤布丁與千層蛋糕是必點，環境舒適，適合過年期間小歇。",
  "位於台南果菜市場周邊的甜點工作室。雖然是隱藏版，但Google評論真實。主推減糖千層與提拉米蘇，是在地人的私房名單。"
];
